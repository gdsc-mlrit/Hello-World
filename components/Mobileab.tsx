...
const Mobileab = () => {
  return (
    <div className="md:hidden flex flex-col justify-center items-center min-h-full pt-16 bg-black">
      {/* <div>
        <div className="py-4 px-0 pr-2 flex flex-col justify-end items-start gap-4">
          <span className="font-['Google Sans']  text-6xl font-bold leading-10 text-white">
            Explore
            <br />
          </span>
          <span className="font-['Google Sans'] text-7xl font-bold  text-limee">
            Startups
          </span>
        </div>
        <div className="p-6 pr-0 relative ">
          <div className="pb-4">
            <span className="text-white text-start text-2xl font-normal font-['Google Sans'] leading-10">
              What are Startups?
            </span>
          </div>
          <div className="pb-4">
          ...
          <div className="px-40 absolute right-15 top-20 z-[0]">
            <svg
              className="h-[150px]"
              viewBox="0 0 499 499"
              fill="none"
      ...
      <div>
        ...
        <div className="p-6 pr-4 relative flex flex-col justify-end items-start gap-1">
          <div className="">
            <span className="text-white text-start text-2xl font-normal font-['Google Sans'] leading-10">
              What are Startups?
            </span>
      ...
      <div>
        <div className="py-4 px-0 pl-2 flex flex-col justify-start items-start gap-4">
          <span className="font-['Google Sans']  text-6xl font-bold leading-10 text-white">
            Explore
            <br />
          </span>
        ...
        <div className="p-6 pr-4 relative flex flex-col justify-end items-start gap-1">
          <div className="">
            <span className="text-white text-2xl text-start font-normal font-['Google Sans'] leading-10">
          ...
          <div className="absolute right-3 top-20 z-0">
            <svg
