        ...
        <div className="w-full flex flex-col pt-4">
          <div className=" h-auto p-6 pt-8 flex flex-row-reverse justify-start pb-0 gap-4 border-r-8 border-[rgb(140,254,62)]">
            <div className="leading-[75px] lg:leading-[100px] flex justify-start items-end flex-col gap-4">
              ...
              <span className="pt-4 pr-[2.9rem] text-end text-[135px] lg:text-[180px] font-bold  text-limee">
                Design
              </span>
            </div>
          ...
          <div className="flex flex-row-reverse justify-between px-0 py-0 pr-5">
            ...
            <div className="flex flex-col justify-center items-center px-0 p-8">
              ...
              <img
                className=" overflow-hidden  w-100 h-80 "
                src="/assets/Sherlock.png"
                alt=""
              />
              ...
              <div className="text-center  z-20 relative">
                <span className="text-limee p-0 text-xl lg:text-2xl font-bold font-['Google Sans'] leading-10">
