...
const AboutGdsc2 = () => {
  return (
    <div className="border-t border-b sm:border border-[#99f94e] sm:rounded-t-[10em] sm:rounded-b-[5em] lg:w-[75%] w-[90%] max-sm:w-full bg-[#1f1f1f] flex justify-center items-center flex-col relative">
      ...
      <div className="flex flex-col justify-center sm:w-[70%] w-[85%] gap-10 sm:py-[5rem] sm:pt-[7rem] py-[2rem]">
        <img src="/gdsclogo.png" alt="" className="sm:py-5 pt-4 max-sm:pt-6" />
