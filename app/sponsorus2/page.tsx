      ...
      <main className="bg-[url(/su-bg.png)] min-h-screen w-full flex justify-center font-hkgrotesk">
        <div className="lg:w-[55%] md:w-[75%] w-[95%] flex flex-col justify-center transition-all gap-10 py-10">
          ...
          <div className="flex flex-col gap-10 mx-auto">
            <h3 className="text-white md:text-3xl lg:text-[2rem] lg:leading-[2.2rem] lg:text-center text-2xl font-semibold pl-5">
            ...
            <h4 className="md:text-xl text-xl text-white pl-7">
              As we delve into the vital domains of technology, design, and
              entrepreneurship, you'll:
            </h4>

            <ul className="text-white list-disc pl-12 md:text-xl text-xl px-2">
              <li>
            ...
            <h4 className="md:text-3xl lg:text-[2rem] lg:leading-[2.2rem] text-2xl lg:pl-10 font-semibold px-5 text-white">
